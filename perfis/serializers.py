...
class PerfilSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        try:
            ...
            raise exceptions.ParseError('Ja existe um usuario cadastrado com esse nome',code=status.HTTP_400_BAD_REQUEST)
...
class PerfilSimplificadoSerializer(serializers.ModelSerializer):
    ...
    def get_pode_convidar(self, obj):
        ...
        if perfil not in contatos and perfil != peril_logado:
            return True
